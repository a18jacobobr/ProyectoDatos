...
Public Class FrmProductos
    ...
    Private Sub PasarDatos(FormularioDestino As FrmAuxiliar)
        With FormularioDestino
            ...
            MostrarValorEnCombo(DtsMProductos.Tables("TipoIva"), "TipoIva", .CmbTiposIva, TxtTipoIva.Text)
            MostrarValorEnCombo(DtsMProductos.Tables("CodProd"), "CodProd", .CmbProveedores, TxtCodProd.Text)
        End With
